    ...
    return (
        <div className="">
                ...
                <div className="ProfileHeader__header d-flex justify-content-between"> 
                    ...
                    {props.currentProfile._id===props.profile._id?<button type="button" className="ProfileHeader__btn ProfileHeader__follow_btn btn btn-outline-primary">Edit profile</button>:props.isFollowed===true?<button type="button" className="ProfileHeader__btn ProfileHeader__following_btn btn " onClick={e=>props.changeFriendship('unfollow')}>Following</button>:<button type="button" className="ProfileHeader__btn ProfileHeader__follow_btn btn btn-outline-primary" onClick={e=>props.changeFriendship('follow')}>Follow</button>}
                </div>
